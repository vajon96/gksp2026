          ...
          <div className="bg-white rounded-3xl max-w-sm w-full p-6.5 shadow-2xl border border-gray-100 overflow-hidden relative animate-fadeIn font-sans">
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              ...
              <div className="relative flex py-2 items-center">
                ...
                <span className="flex-shrink mx-3 text-[10px] text-gray-400 font-extrabold uppercase tracking-wider">{lang === "en" ? "Or Continue With" : "অথবা অন্যভাবে"}</span>
                <div className="flex-grow border-t border-gray-150"></div>
              </div>
              ...
              <button
                ...
                disabled={isLoggingIn}
                className="w-full py-2.5 bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 text-xs font-bold rounded-xl transition-all shadow-xs cursor-pointer flex items-center justify-center gap-2 select-none disabled:opacity-50"
              >
                ...
                {lang === "en" ? "Sign in with Google" : "গুগল অ্যাকাউন্ট দিয়ে লগইন"}
              </button>
            </form>
          </div>
        </div>
